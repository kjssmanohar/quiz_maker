...
WEB_APP_URL = "https://script.google.com/macros/s/AKfycbxk7kTLRs2KQyp3PSrie4BdqTNSSH8PKQr9CXMst4wxZPS8R7TmkKVhtDcefJen8iXdKA/exec"
...
if uploaded_file and st.button("Generate Quiz"):
    try:
        ...
        # === Show Top Scorer after generation ===
        st.markdown("---")
...
# Optional: Toggle to view Top Scorer even without file upload
